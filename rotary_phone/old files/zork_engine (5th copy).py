...
zork_map = {
    ...
    "north_of_house": {
        ...
        "instruction_audio": "instructions/north_of_house_instructions.wav", # NEW!
        "exits": {"1": "west_of_house", "7": "behind_house", "4": "forest_path"}, # Added North
        "interactions": {}
    },
    "forest_path": {
        "audio_desc": "locations/forest_path.wav",
        "exits": {"0": "north_of_house"}, # South returns to the house
        "interactions": {}
    },
    "behind_house": {
