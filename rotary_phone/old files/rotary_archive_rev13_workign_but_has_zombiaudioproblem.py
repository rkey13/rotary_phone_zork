...
def play_sound(filepath, blocking=False):
    """Plays an optimized WAV audio file instantly."""
    global current_process
    stop_active_process() 
    
    # Because the sync script now ensures everything is a WAV, we ONLY need aplay!
    # Using plughw:0,0 ensures it goes straight to your USB sound card
